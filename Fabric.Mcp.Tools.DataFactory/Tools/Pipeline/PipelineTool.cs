...
using Fabric.Mcp.Tools.DataFactory.Models.Pipeline.Definition;
using Fabric.Mcp.Tools.DataFactory.Models.Pipeline.Schedule;

namespace Fabric.Mcp.Tools.DataFactory.Tools.Pipeline;
