using Fabric.Mcp.Tools.DataFactory.Models.Dataflow;
using Fabric.Mcp.Tools.DataFactory.Models.Dataflow.Definition;
using Fabric.Mcp.Tools.DataFactory.Models.Dataflow.Query;
using Fabric.Mcp.Tools.DataFactory.Models.Connection;
...
public interface IFabricDataflowService
{
    ...
    /// Pass an empty collection with clearExisting=true to clear all connections.
    /// </summary>
    /// <param name="workspaceId">The workspace ID containing the dataflow</param>
    /// <param name="dataflowId">The dataflow ID to update</param>
    ...
    Task<UpdateDataflowDefinitionResponse> AddConnectionsToDataflowAsync(
        string workspaceId,
        string dataflowId,
        IEnumerable<(string ConnectionId, Fabric.Mcp.Tools.DataFactory.Models.Connection.Connection Connection)> connections,
