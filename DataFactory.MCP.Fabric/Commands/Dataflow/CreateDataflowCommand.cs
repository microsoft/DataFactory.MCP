...
using DataFactory.MCP.Fabric.Options.Dataflow;
...
namespace DataFactory.MCP.Fabric.Commands.Dataflow;
    ...
    IFabricDataflowService dataflowService) : GlobalCommand<CreateDataflowOptions>()
{
    ...
    public override async Task<CommandResponse> ExecuteAsync(CommandContext context, ParseResult parseResult, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var dataflow = new DataFactory.MCP.Models.Dataflow.Dataflow
            {
                Id = response.Id,
